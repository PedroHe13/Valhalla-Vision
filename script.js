...
function loadQuiz() {
    ...
    restartBtn.addEventListener('click', function() {
        currentQuestion = 0;
        score = 0;
        userAnswers.length = 0; // Limpar respostas do usuário
    ...
    function loadQuestion() {
        ...
        currentQuiz.options.forEach((option, index) => {
            ...
            optionDiv.addEventListener('click', function() {
                ...
                updateUserAnswer(currentQuestion, selectedOption); // Salvar a resposta do usuário
            });
    ...
    function showResults() {
        ...
        quizData.forEach((quizItem, index) => {
            ...
            const userAnswer = userAnswers[index]; // Obter a resposta do usuário
            ...
            resultItem.innerHTML = `
                ...
                <span class="${isCorrect ? 'correct' : 'incorrect'}">
                    Sua resposta: ${userAnswer !== undefined ? quizItem.options[userAnswer] : 'Não respondida'}
